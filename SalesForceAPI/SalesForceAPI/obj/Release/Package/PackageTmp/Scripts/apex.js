...
sforce.Apex.prototype.executeAnonymous = function (string, callback) {
    ...
    return sforce.connection._invoke("executeAnonymous",[arg1], false,
            callback, this.namespaceMap, (typeof UserContext.siteUrlPrefix != "undefined") ? UserContext.getUrl("/services/Soap/s/32.0") : "/services/Soap/s/32.0", this.namespaceMap[0].ns);
};
...
sforce.Apex.prototype.runTests = function (request, callback) {
    ...
    return sforce.connection._invoke("runTests",[arg1], false,
            callback, this.namespaceMap, (typeof window.UserContext != "undefined") ? UserContext.getUrl("/services/Soap/s/32.0") : "/services/Soap/s/32.0", this.namespaceMap[0].ns);
};
